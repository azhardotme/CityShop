            ...
            <div id="aside" class="col-md-3">
                ...
                <div class="aside">
                    ...
                    <div class="checkbox-filter">
                        ...
                        @php
                         $subcatCount=\App\Models\Product::subcatProductCount($subcategories->id);
                        @endphp
                        <div class="input-checkbox">
                            ...
                            <label for="category-1">
                                <span></span>
                                <li>
                                    <a href="{{url('/product_by_subcate/'.$subcategories->id)}}"></a>
                                </li>
                             {{$subcategories->name}}
                ...
                <div class="aside">
                    ...
                    <div class="checkbox-filter">
                        ...
                        @php
                        $brandCount=\App\Models\Product::brandProductCount($brands->id);
                       @endphp
                        <div class="input-checkbox">
