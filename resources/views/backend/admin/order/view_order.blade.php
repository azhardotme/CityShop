        ...
        <div class="box span12" style="margin-left: auto;">
            ...
            <div class="box-content">
                <table class="table table-striped">
                    ...
                    <tbody>
                        @foreach ($order_by_id as $obi)
                        <tr>
                            <td>{{ $obi->order_id}}</td>
                            <td class="center">{{ $obi->product_name}}</td>
                            <td class="center">&#2547; {{ $obi->product_price}}</td>
                            <td class="center">{{ $obi->product_sales_quantity}}</td>
                            <td class="center"> &#2547; {{$obi->product_price*$obi->product_sales_quantity}}</td>
                        </tr>
                        @endforeach
                    </tbody>
